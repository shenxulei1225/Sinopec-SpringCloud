package cn.cheers.x.pay.framework.pay.core.client.impl.wallet;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.map.MapUtil;
import cn.hutool.extra.spring.SpringUtil;
import cn.cheers.x.framework.common.exception.ServiceException;
import cn.cheers.x.pay.enums.PayChannelEnum;
import cn.cheers.x.pay.enums.refund.PayRefundStatusEnum;
import cn.cheers.x.pay.enums.transfer.PayTransferStatusEnum;
import cn.cheers.x.pay.framework.pay.core.client.dto.order.PayOrderRespDTO;
import cn.cheers.x.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import cn.cheers.x.pay.framework.pay.core.client.dto.refund.PayRefundRespDTO;
import cn.cheers.x.pay.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import cn.cheers.x.pay.framework.pay.core.client.dto.transfer.PayTransferRespDTO;
import cn.cheers.x.pay.framework.pay.core.client.dto.transfer.PayTransferUnifiedReqDTO;
import cn.cheers.x.pay.framework.pay.core.client.impl.AbstractPayClient;
import cn.cheers.x.pay.framework.pay.core.client.impl.NonePayClientConfig;
import cn.cheers.x.pay.dal.dataobject.order.PayOrderExtensionDO;
import cn.cheers.x.pay.dal.dataobject.refund.PayRefundDO;
import cn.cheers.x.pay.dal.dataobject.transfer.PayTransferDO;
import cn.cheers.x.pay.dal.dataobject.wallet.PayWalletTransactionDO;
...
import cn.cheers.x.pay.service.wallet.PayWalletTransactionService;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.cheers.x.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.cheers.x.pay.enums.ErrorCodeConstants.PAY_ORDER_EXTENSION_NOT_FOUND;
import static cn.cheers.x.pay.enums.ErrorCodeConstants.REFUND_NOT_FOUND;
