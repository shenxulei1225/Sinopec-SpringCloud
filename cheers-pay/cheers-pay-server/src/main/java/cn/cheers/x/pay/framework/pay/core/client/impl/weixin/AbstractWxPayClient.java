package cn.cheers.x.pay.framework.pay.core.client.impl.weixin;
...
import cn.cheers.x.framework.common.util.io.FileUtils;
...
import static cn.cheers.x.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static cn.cheers.x.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected void doInit(String tradeType) {
        ...
        if (Objects.equals(config.getApiVersion(), API_VERSION_V2)) {
            ...
            // 参考 https://gitee.com/yudaocode/cheers-ui-admin-vue3/issues/ICUE53 和 https://t.zsxq.com/ODR5V
