package cn.cheers.x.iot.gateway.config;

import cn.cheers.x.iot.core.enums.IotProtocolTypeEnum;
import cn.cheers.x.iot.gateway.protocol.coap.IotCoapConfig;
import cn.cheers.x.iot.gateway.protocol.emqx.IotEmqxConfig;
import cn.cheers.x.iot.gateway.protocol.http.IotHttpConfig;
import cn.cheers.x.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import cn.cheers.x.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import cn.cheers.x.iot.gateway.protocol.mqtt.IotMqttConfig;
import cn.cheers.x.iot.gateway.protocol.tcp.IotTcpConfig;
import cn.cheers.x.iot.gateway.protocol.udp.IotUdpConfig;
import cn.cheers.x.iot.gateway.protocol.websocket.IotWebSocketConfig;
...
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see cn.cheers.x.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see cn.cheers.x.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
