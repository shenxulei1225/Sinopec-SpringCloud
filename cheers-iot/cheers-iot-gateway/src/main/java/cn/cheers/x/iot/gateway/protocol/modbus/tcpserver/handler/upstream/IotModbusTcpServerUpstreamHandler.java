package cn.cheers.x.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.cheers.x.iot.core.biz.IotDeviceCommonApi;
import cn.cheers.x.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.cheers.x.iot.core.biz.dto.IotDeviceRespDTO;
import cn.cheers.x.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.cheers.x.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.cheers.x.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.cheers.x.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import cn.cheers.x.iot.core.mq.message.IotDeviceMessage;
import cn.cheers.x.iot.core.topic.IotDeviceIdentity;
import cn.cheers.x.iot.core.util.IotDeviceAuthUtils;
import cn.cheers.x.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.cheers.x.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.cheers.x.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.cheers.x.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.cheers.x.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.cheers.x.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.cheers.x.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.cheers.x.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.cheers.x.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.cheers.x.iot.gateway.service.device.IotDeviceService;
import cn.cheers.x.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.cheers.x.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
