package cn.cheers.x.iot.gateway.protocol.tcp;
...
import cn.cheers.x.iot.core.topic.topo.IotDeviceTopoGetReqDTO;
import cn.cheers.x.iot.core.util.IotDeviceAuthUtils;
import cn.cheers.x.iot.gateway.protocol.tcp.codec.IotTcpCodecTypeEnum;
import cn.cheers.x.iot.gateway.protocol.tcp.codec.IotTcpFrameCodec;
import cn.cheers.x.iot.gateway.protocol.tcp.codec.IotTcpFrameCodecFactory;
import cn.cheers.x.iot.gateway.serialize.IotMessageSerializer;
import cn.cheers.x.iot.gateway.serialize.json.IotJsonSerializer;
 ...
 * <p>使用步骤：
 * <ol>
 *     <li>启动 cheers-iot-gateway 服务（TCP 端口 8091）</li>
 *     <li>运行以下测试方法：
 *         <ul>
