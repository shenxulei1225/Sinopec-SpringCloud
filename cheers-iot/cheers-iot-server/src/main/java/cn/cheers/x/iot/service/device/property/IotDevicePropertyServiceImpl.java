package cn.cheers.x.iot.service.device.property;
...
import cn.cheers.x.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import cn.cheers.x.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
import cn.cheers.x.iot.core.mq.message.IotDeviceMessage;
import cn.cheers.x.iot.dal.dataobject.device.IotDeviceDO;
import cn.cheers.x.iot.dal.dataobject.device.IotDevicePropertyDO;
import cn.cheers.x.iot.dal.dataobject.product.IotProductDO;
import cn.cheers.x.iot.dal.dataobject.thingmodel.IotThingModelDO;
import cn.cheers.x.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import cn.cheers.x.iot.dal.redis.device.DevicePropertyRedisDAO;
import cn.cheers.x.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import cn.cheers.x.iot.dal.redis.device.DeviceServerIdRedisDAO;
import cn.cheers.x.iot.dal.tdengine.IotDevicePropertyMapper;
import cn.cheers.x.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import cn.cheers.x.iot.enums.thingmodel.IotThingModelTypeEnum;
import cn.cheers.x.iot.framework.tdengine.core.TDengineTableField;
import cn.cheers.x.iot.service.device.IotDeviceService;
import cn.cheers.x.iot.service.product.IotProductService;
import cn.cheers.x.iot.service.thingmodel.IotThingModelService;
...
import static cn.cheers.x.framework.common.util.collection.MapUtils.getBigDecimal;
