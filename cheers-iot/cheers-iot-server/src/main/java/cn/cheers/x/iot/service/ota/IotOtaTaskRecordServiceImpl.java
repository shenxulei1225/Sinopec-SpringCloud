package cn.cheers.x.iot.service.ota;
...
import cn.cheers.x.iot.controller.admin.ota.vo.task.record.IotOtaTaskRecordPageReqVO;
import cn.cheers.x.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.cheers.x.iot.core.mq.message.IotDeviceMessage;
import cn.cheers.x.iot.core.topic.ota.IotDeviceOtaProgressReqDTO;
import cn.cheers.x.iot.core.topic.ota.IotDeviceOtaUpgradeReqDTO;
import cn.cheers.x.iot.dal.dataobject.device.IotDeviceDO;
import cn.cheers.x.iot.dal.dataobject.ota.IotOtaFirmwareDO;
import cn.cheers.x.iot.dal.dataobject.ota.IotOtaTaskRecordDO;
import cn.cheers.x.iot.dal.mysql.ota.IotOtaTaskRecordMapper;
import cn.cheers.x.iot.enums.ota.IotOtaTaskRecordStatusEnum;
