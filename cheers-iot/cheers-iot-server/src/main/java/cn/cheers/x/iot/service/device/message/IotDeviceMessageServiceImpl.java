package cn.cheers.x.iot.service.device.message;
...
import cn.cheers.x.iot.controller.admin.device.vo.message.IotDeviceMessagePageReqVO;
import cn.cheers.x.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageReqVO;
import cn.cheers.x.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageSummaryByDateRespVO;
import cn.cheers.x.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.cheers.x.iot.core.mq.message.IotDeviceMessage;
import cn.cheers.x.iot.core.mq.producer.IotDeviceMessageProducer;
import cn.cheers.x.iot.core.topic.IotDeviceIdentity;
import cn.cheers.x.iot.core.topic.event.IotDeviceEventPostReqDTO;
import cn.cheers.x.iot.core.topic.property.IotDevicePropertyPackPostReqDTO;
import cn.cheers.x.iot.core.topic.property.IotDevicePropertyPostReqDTO;
import cn.cheers.x.iot.core.util.IotDeviceMessageUtils;
import cn.cheers.x.iot.dal.dataobject.device.IotDeviceDO;
import cn.cheers.x.iot.dal.dataobject.device.IotDeviceMessageDO;
import cn.cheers.x.iot.dal.tdengine.IotDeviceMessageMapper;
import cn.cheers.x.iot.service.device.IotDeviceService;
import cn.cheers.x.iot.service.device.property.IotDevicePropertyService;
import cn.cheers.x.iot.service.ota.IotOtaTaskRecordService;
...
import static cn.cheers.x.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED_SERVER_ID_NULL;
