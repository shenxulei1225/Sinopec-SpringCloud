package cn.cheers.x.iot.service.device;
...
import cn.cheers.x.iot.controller.admin.device.vo.device.*;
import cn.cheers.x.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.cheers.x.iot.core.biz.dto.IotSubDeviceRegisterFullReqDTO;
import cn.cheers.x.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.cheers.x.iot.core.enums.device.IotDeviceStateEnum;
import cn.cheers.x.iot.core.mq.message.IotDeviceMessage;
import cn.cheers.x.iot.core.topic.IotDeviceIdentity;
import cn.cheers.x.iot.core.topic.auth.IotDeviceRegisterReqDTO;
import cn.cheers.x.iot.core.topic.auth.IotDeviceRegisterRespDTO;
import cn.cheers.x.iot.core.topic.auth.IotSubDeviceRegisterReqDTO;
import cn.cheers.x.iot.core.topic.auth.IotSubDeviceRegisterRespDTO;
import cn.cheers.x.iot.core.topic.topo.IotDeviceTopoAddReqDTO;
import cn.cheers.x.iot.core.topic.topo.IotDeviceTopoChangeReqDTO;
import cn.cheers.x.iot.core.topic.topo.IotDeviceTopoDeleteReqDTO;
import cn.cheers.x.iot.core.topic.topo.IotDeviceTopoGetRespDTO;
import cn.cheers.x.iot.core.util.IotDeviceAuthUtils;
import cn.cheers.x.iot.core.util.IotProductAuthUtils;
import cn.cheers.x.iot.dal.dataobject.device.IotDeviceDO;
import cn.cheers.x.iot.dal.dataobject.device.IotDeviceGroupDO;
import cn.cheers.x.iot.dal.dataobject.product.IotProductDO;
import cn.cheers.x.iot.dal.mysql.device.IotDeviceMapper;
import cn.cheers.x.iot.dal.redis.RedisKeyConstants;
import cn.cheers.x.iot.enums.product.IotProductDeviceTypeEnum;
import cn.cheers.x.iot.service.device.message.IotDeviceMessageService;
import cn.cheers.x.iot.service.product.IotProductService;
...
import static cn.cheers.x.iot.enums.ErrorCodeConstants.*;
