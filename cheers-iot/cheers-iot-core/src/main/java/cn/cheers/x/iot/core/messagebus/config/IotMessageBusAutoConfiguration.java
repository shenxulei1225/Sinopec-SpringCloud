package cn.cheers.x.iot.core.messagebus.config;
...
import cn.cheers.x.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.cheers.x.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.cheers.x.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    /**
     * 特殊：由于 CheersRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.cheers.x.framework.mq.redis.config.CheersRedisMQConsumerAutoConfiguration
     */
    @Configuration
