...
SET
    data_source = '{"businessCategory":"category","entityTypeCode":"view","dataKind":"entity"}'::jsonb,
...
UPDATE pr_component_props
SET
    data_source = '{"businessCategory":"category","entityTypeCode":"facility","dataKind":"entity"}'::jsonb,
