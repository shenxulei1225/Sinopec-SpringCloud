package cn.cheers.x.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.thread.ThreadUtil;
import cn.hutool.core.util.StrUtil;
import cn.cheers.x.framework.common.pojo.PageResult;
import cn.cheers.x.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import cn.cheers.x.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import cn.cheers.x.mp.convert.message.MpMessageConvert;
import cn.cheers.x.mp.dal.dataobject.account.MpAccountDO;
import cn.cheers.x.mp.dal.dataobject.message.MpMessageDO;
import cn.cheers.x.mp.dal.dataobject.user.MpUserDO;
import cn.cheers.x.mp.dal.mysql.message.MpMessageMapper;
import cn.cheers.x.mp.enums.message.MpMessageSendFromEnum;
import cn.cheers.x.mp.framework.mp.core.MpServiceFactory;
import cn.cheers.x.mp.framework.mp.core.util.MpUtils;
import cn.cheers.x.mp.service.account.MpAccountService;
import cn.cheers.x.mp.service.material.MpMaterialService;
import cn.cheers.x.mp.service.message.bo.MpMessageSendOutReqBO;
import cn.cheers.x.mp.service.user.MpUserService;
...
import static cn.cheers.x.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
