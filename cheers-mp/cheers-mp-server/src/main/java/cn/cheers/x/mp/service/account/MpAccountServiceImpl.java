package cn.cheers.x.mp.service.account;
...
import cn.cheers.x.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.cheers.x.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.cheers.x.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.cheers.x.mp.convert.account.MpAccountConvert;
import cn.cheers.x.mp.dal.dataobject.account.MpAccountDO;
import cn.cheers.x.mp.dal.mysql.account.MpAccountMapper;
import cn.cheers.x.mp.enums.ErrorCodeConstants;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 cheers-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
