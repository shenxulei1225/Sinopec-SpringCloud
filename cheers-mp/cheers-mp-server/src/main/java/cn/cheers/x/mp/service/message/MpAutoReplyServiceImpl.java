...
import cn.cheers.x.mp.controller.admin.message.vo.autoreply.MpAutoReplyCreateReqVO;
import cn.cheers.x.mp.controller.admin.message.vo.autoreply.MpAutoReplyUpdateReqVO;
import cn.cheers.x.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import cn.cheers.x.mp.convert.message.MpAutoReplyConvert;
import cn.cheers.x.mp.dal.dataobject.account.MpAccountDO;
import cn.cheers.x.mp.dal.dataobject.message.MpAutoReplyDO;
import cn.cheers.x.mp.dal.mysql.message.MpAutoReplyMapper;
import cn.cheers.x.mp.enums.message.MpAutoReplyTypeEnum;
...
import static cn.cheers.x.mp.enums.ErrorCodeConstants.*;
