        ...
        LOOP
            ...
            ELSE
                ...
                RAISE NOTICE '创建第一级别分类: 页面配置 % (menu_id: %), 视图 "%", 分类ID %, 分类名称 "%"', 
                    page_config_record.id, page_config_record.menu_id, view_name, top_level_category_id, category_system_name;
            END IF;
            ...
            view_item := view_item || jsonb_build_object(
                ...
                'categorySystemName', category_system_name
            );
