-- ============================================================================
-- V1.0.17: 为 system_model_field_assignment 表添加 field_source 字段
...
-- 添加字段注释
COMMENT ON COLUMN system_model_field_assignment.field_source IS '字段来源：TEMPLATE_COPIED-从模板复制,USER_ADDED-用户添加';
...
CREATE INDEX IF NOT EXISTS idx_model_field_assignment_source 
    ON system_model_field_assignment(model_id, field_source) 
    WHERE deleted = FALSE;
