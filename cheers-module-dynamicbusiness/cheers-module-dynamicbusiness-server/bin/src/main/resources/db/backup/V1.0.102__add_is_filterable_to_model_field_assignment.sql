-- ============================================================================
-- V1.0.102: 为模型字段分配表增加 is_filterable
-- 描述：支持在模型字段分配层独立配置“是否可筛选”
-- ============================================================================
...
-- 2) 列注释
COMMENT ON COLUMN system_model_field_assignment.is_filterable
...
ON system_model_field_assignment (model_id, is_filterable)
WHERE deleted = FALSE;
