-- ============================================================================
-- 将 system_entity 表的 custom_fields 列升级为 JSONB 类型
-- 版本：V1.0.25
-- 日期：2026-01-07
-- 说明：
...
CREATE INDEX IF NOT EXISTS idx_system_entity_custom_fields 
    ON system_entity USING GIN (custom_fields);

-- 4. 更新列注释
COMMENT ON COLUMN system_entity.custom_fields IS '自定义字段数据（JSONB格式,支持 @> 操作符查询）';

-- 5. 分析表以更新统计信息,优化查询计划
ANALYZE system_entity;
