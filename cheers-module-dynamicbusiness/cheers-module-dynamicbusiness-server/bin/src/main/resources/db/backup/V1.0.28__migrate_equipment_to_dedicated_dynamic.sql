...
-- =====================================================
-- 第一步：更新 system_business_type_config 配置
-- =====================================================
...
UPDATE system_business_type_config 
SET 
...
SELECT 
    ...
    0   -- tenant_id: 系统级
WHERE NOT EXISTS (
    SELECT 1 FROM system_dynamic_table WHERE table_name = 'biz_equipment'
);
...
INSERT INTO system_dynamic_table_audit_log (
    dynamic_table_id,
    operation_type,
    operation_desc,
    before_config,
