...
public class ModelCreatedEvent extends ApplicationEvent {
    ...
    public static ModelCreatedEvent of(Object source, Long modelId, String modelCode, String modelName,
                                       String entityTypeCode, Long parentModelId, Boolean isTemplate, Long tenantId) {
        return new ModelCreatedEvent(source, modelId, modelCode, modelName, entityTypeCode, tenantId);
    }
