...
public interface CategoryModelEntityQueryService {
     ...
     * @param businessTypeCode 业务类型编码（用于筛选模型，并路由实体表）
     * @return 实体树（根节点列表）
     */
    List<EntityRespVO> getEntityTreeByCategory(Long categoryId, String businessTypeCode);
     ...
     */
    PageResult<EntityRespVO> pageEntityByCategory(Long categoryId, String businessTypeCode,
