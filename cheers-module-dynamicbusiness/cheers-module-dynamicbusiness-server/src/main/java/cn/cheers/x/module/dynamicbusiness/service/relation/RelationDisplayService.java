...
public interface RelationDisplayService {
     ...
     * @return 展示值
     */
    String getDisplayValue(String targetEntityType, String targetModelCode, 
     ...
     */
    Map<Long, String> getDisplayValues(String targetEntityType, String targetModelCode,
     ...
     * @return 实际使用的展示字段编码
     */
    String getEffectiveDisplayFieldCode(String targetEntityType, String targetModelCode,
     ...
     * @return 展示信息
     */
    RelationDisplayInfo getDisplayInfo(String targetEntityType, String targetModelCode,
                                        Long entityId, String displayFieldCode);
