 ...
 * <h3>应用场景</h3>
 * <ul>
 *   <li><b>接口</b>:GET /system/entity-type/relation/list、GET /system/entity-type/relation/get</li>
 ...
 * <h3>关键字段说明</h3>
 * <ul>
 *   <li><b>sourceEntityTypeCode/Name</b>:源业务类型信息</li>
 *   <li><b>targetEntityTypeCode/Name</b>:目标业务类型信息</li>
 * </ul>
 * 

 * <h3>与其他 VO 的关系</h3>
 * <ul>
 *   <li>创建请求 → {@link EntityTypeRelationCreateReqVO}</li>
 * </ul>
 * 
 * @author yudao
 */
@Schema(description = "管理后台 - EntityType 关联 Response VO")
@Data
public class EntityTypeRelationRespVO {
