...
public class ModelCategoryRelationController {
    ...
    public CommonResult<Boolean> associate(
        ...
        return success(relationService.associate(modelId, categoryId, businessTypeCode) != null);
    }
    ...
    public CommonResult<Boolean> disassociate(
            ...
            @RequestParam("categoryId") Long categoryId,
            @RequestParam("businessTypeCode") String businessTypeCode) {
        return success(relationService.disassociate(modelId, categoryId, businessTypeCode) != null);
    }
    ...
    public CommonResult<Boolean> existsRelation(
            ...
            @RequestParam("categoryId") Long categoryId,
            @RequestParam("businessTypeCode") String businessTypeCode) {
        return success(relationService.existsRelation(modelId, categoryId, businessTypeCode));
    }
    ...
    public CommonResult<Boolean> batchAssociateModelToCategories(
        ...
        return success(relationService.batchAssociateModelToCategories(modelId, categoryIds, businessTypeCode) != null);
    }
    ...
    public CommonResult<Boolean> batchDisassociateModelFromCategories(
            ...
            @RequestParam("businessTypeCode") String businessTypeCode,
            @RequestBody List<Long> categoryIds) {
        return success(relationService.batchDisassociateModelFromCategories(modelId, categoryIds, businessTypeCode) != null);
    }
    ...
    public CommonResult<Boolean> updateAssociation(
            ...
            @RequestParam("businessTypeCode") String businessTypeCode,
            @RequestBody List<Long> categoryIds) {
        return success(relationService.updateAssociation(modelId, categoryIds, businessTypeCode) != null);
    }
    ...
    public CommonResult<BatchModelCategoryAssociationRespVO> batchAssociateModelsToCategory(
        ...
        return success(relationService.batchAssociateModelsToCategory(modelIds, categoryId, businessTypeCode));
    }
    ...
    public CommonResult<BatchModelCategoryAssociationRespVO> batchDisassociateModelsFromCategory(
            ...
            @RequestParam("businessTypeCode") String businessTypeCode,
            @RequestBody List<Long> modelIds) {
        return success(relationService.batchDisassociateModelsFromCategory(modelIds, categoryId, businessTypeCode));
    }
    ...
    public CommonResult<BatchModelCategoryAssociationRespVO> batchAssociateModelsToCategories(
            ...
            @RequestBody List<Long> categoryIds) {
        return success(relationService.batchAssociateModelsToCategories(modelIds, categoryIds, businessTypeCode));
    }
    ...
    public CommonResult<BatchModelCategoryAssociationRespVO> batchDisassociateModelsFromCategories(
            ...
            @RequestParam("modelIds") List<Long> modelIds,
            @RequestBody List<Long> categoryIds) {
        return success(relationService.batchDisassociateModelsFromCategories(modelIds, categoryIds, businessTypeCode));
    }
    ...
    public CommonResult<BatchModelCategoryAssociationRespVO> batchUpdateAssociation(
            ...
            @RequestParam("modelIds") List<Long> modelIds,
            @RequestBody List<Long> categoryIds) {
        return success(relationService.batchUpdateAssociation(modelIds, categoryIds, businessTypeCode));
    }
    ...
    public CommonResult<List<Long>> getModelCategoryIds(@PathVariable("modelId") Long modelId,
                                                            @RequestParam("businessTypeCode") String businessTypeCode) {
        return success(relationService.listCategoryIdsByModelId(modelId, businessTypeCode));
    }
    ...
    public CommonResult<List<Long>> getCategoryModelIds(@PathVariable("categoryId") Long categoryId,
                                                            @RequestParam("businessTypeCode") String businessTypeCode) {
        return success(relationService.listModelIdsByCategoryIdOnly(categoryId, businessTypeCode));
    }
    ...
    public CommonResult<List<Long>> listModelIdsByCategoryIdWithDescendants(
            @PathVariable("categoryId") Long categoryId,
            @RequestParam("businessTypeCode") String businessTypeCode) {
        return success(relationService.listModelIdsByCategoryIdWithDescendants(categoryId, businessTypeCode));
    }
    ...
    public CommonResult<List<Long>> listModelIdsByCategoryIdsOnly(
            ...
            @RequestParam("businessTypeCode") String businessTypeCode) {
        return success(relationService.listModelIdsByCategoryIdsOnly(categoryIds, businessTypeCode));
    }
    ...
    public CommonResult<List<Long>> listModelIdsByCategoryIdsWithDescendants(
            @RequestParam("categoryIds") List<Long> categoryIds,
            @RequestParam("businessTypeCode") String businessTypeCode) {
        return success(relationService.listModelIdsByCategoryIdsWithDescendants(categoryIds, businessTypeCode));
    }
    ...
    public CommonResult<PageResult<Long>> pageModelIdsByCategoryIdOnly(
        ...
        return success(relationService.pageModelIdsByCategoryIdOnly(categoryId, businessTypeCode, pageNo, pageSize));
    }
    ...
    public CommonResult<PageResult<Long>> pageModelIdsByCategoryIdWithDescendants(
            ...
            @RequestParam("pageNo") Integer pageNo,
            @RequestParam("pageSize") Integer pageSize) {
        return success(relationService.pageModelIdsByCategoryIdWithDescendants(categoryId, businessTypeCode, pageNo, pageSize));
    }
    ...
    public CommonResult<PageResult<Long>> pageModelIdsByCategoryIdsOnly(
            ...
            @RequestParam("pageNo") Integer pageNo,
            @RequestParam("pageSize") Integer pageSize) {
        return success(relationService.pageModelIdsByCategoryIdsOnly(categoryIds, businessTypeCode, pageNo, pageSize));
    }
    ...
    public CommonResult<PageResult<Long>> pageModelIdsByCategoryIdsWithDescendants(
            ...
            @RequestParam("pageNo") Integer pageNo,
            @RequestParam("pageSize") Integer pageSize) {
        return success(relationService.pageModelIdsByCategoryIdsWithDescendants(categoryIds, businessTypeCode, pageNo, pageSize));
    }
    ...
    public CommonResult<PageResult<Long>> pageModelIdsByCategoryIdsOnlyDb(
            ...
            @RequestParam("pageNo") Integer pageNo,
            @RequestParam("pageSize") Integer pageSize) {
        return success(relationService.pageModelIdsByCategoryIdsOnlyDb(categoryIds, businessTypeCode, pageNo, pageSize));
    }
    ...
    public CommonResult<PageResult<Long>> pageModelIdsByCategoryIdsWithDescendantsDb(
            ...
            @RequestParam("pageNo") Integer pageNo,
            @RequestParam("pageSize") Integer pageSize) {
        return success(relationService.pageModelIdsByCategoryIdsWithDescendantsDb(categoryIds, businessTypeCode, pageNo, pageSize));
    }
    ...
    public CommonResult<Boolean> deleteAllByCategoryIdInBusiness(
            @PathVariable("categoryId") Long categoryId,
            @RequestParam("businessTypeCode") String businessTypeCode) {
        relationService.deleteAllByCategoryIdInBusiness(categoryId, businessTypeCode);
        return success(true);
    }
    ...
    public CommonResult<Boolean> deleteAllByCategoryIdsInBusiness(
            @RequestParam("categoryIds") List<Long> categoryIds,
            @RequestParam("businessTypeCode") String businessTypeCode) {
        relationService.deleteAllByCategoryIdsInBusiness(categoryIds, businessTypeCode);
        return success(true);
    }
}
