 ...
 * 模型字段分组更新请求 VO
 */
@Schema(description = "管理后台 - 模型字段分组更新请求 VO")
@Data
@EqualsAndHashCode(callSuper = true)
public class ModelFieldGroupUpdateReqVO extends ModelFieldGroupBaseVO {

    @Schema(description = "模型ID", example = "1024", required = true)
    @NotNull(message = "模型ID不能为空")
    private Long modelId;

    @Schema(description = "分组ID", example = "1024", required = true)
