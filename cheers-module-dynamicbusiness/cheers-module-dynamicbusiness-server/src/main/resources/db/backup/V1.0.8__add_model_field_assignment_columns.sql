-- ============================================================================
-- V1.0.8: 为 dynamic_model_field_assignment 表添加缺失的列
...
-- 添加字段注释
COMMENT ON COLUMN dynamic_model_field_assignment.sort IS '排序值';
COMMENT ON COLUMN dynamic_model_field_assignment.ref_library_id IS '关联字段库ID,当字段类型为ENTITY_REF时使用';
COMMENT ON COLUMN dynamic_model_field_assignment.is_inherited IS '是否继承自模板,继承的关联字段不可移除';
