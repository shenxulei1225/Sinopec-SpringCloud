...
SELECT
    ...
    3,
    1,
    (SELECT id FROM dynamic_menu WHERE permission = 'system:page:query' AND type = 2 LIMIT 1),
    '', '', '', '', 0, true, true, false, 'admin', NOW(), 'admin', NOW(), false
WHERE NOT EXISTS (
    SELECT 1 FROM dynamic_menu WHERE permission = 'system:page:create'
)
AND EXISTS (
    SELECT 1 FROM dynamic_menu WHERE permission = 'system:page:query' AND type = 2
);
...
SELECT
    ...
    '', '', '', '', 0, true, true, false, 'admin', NOW(), 'admin', NOW(), false
WHERE NOT EXISTS (
    SELECT 1 FROM dynamic_menu WHERE permission = 'system:page:update'
)
AND EXISTS (
    SELECT 1 FROM dynamic_menu WHERE permission = 'system:page:query' AND type = 2
);
...
SELECT
    ...
    '', '', '', '', 0, true, true, false, 'admin', NOW(), 'admin', NOW(), false
WHERE NOT EXISTS (
    SELECT 1 FROM dynamic_menu WHERE permission = 'system:page:delete'
)
AND EXISTS (
    SELECT 1 FROM dynamic_menu WHERE permission = 'system:page:query' AND type = 2
);
