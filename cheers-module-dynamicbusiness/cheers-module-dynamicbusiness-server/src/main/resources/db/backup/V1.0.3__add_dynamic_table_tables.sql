...
CREATE INDEX IF NOT EXISTS idx_dynamic_table_business_type ON dynamic_dynamic_table(business_type_code);
...
COMMENT ON COLUMN dynamic_dynamic_table.business_type_code IS '业务类型编码';
