...
cd cheers-module-dynamicbusiness/scripts/platform-import
./import-dev-all.sh
```
...
见 `cheers-module-dynamicbusiness-server/src/main/resources/db/migration/dynamicbusiness/README.md`。
