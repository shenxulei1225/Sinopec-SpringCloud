...
SELECT 'dynamic_business_type' AS item, COUNT(*)::text AS cnt
FROM dynamicbusiness.dynamic_business_type WHERE deleted = FALSE
UNION ALL
...
UNION ALL
SELECT 'biz_equipment', COUNT(*)::text FROM dynamicbusiness.biz_equipment WHERE deleted = FALSE
UNION ALL
...
\echo ''
\echo '=== 建议 ==='
\echo '若 Flyway 历史含 V3/V14 等旧版本，或 biz_equipment 接近 0：'
