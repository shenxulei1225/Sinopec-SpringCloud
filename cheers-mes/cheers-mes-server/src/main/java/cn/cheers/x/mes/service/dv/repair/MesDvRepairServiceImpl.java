package cn.cheers.x.mes.service.dv.repair;
...
import cn.cheers.x.mes.dal.mysql.dv.repair.MesDvRepairMapper;
import cn.cheers.x.mes.enums.dv.MesDvRepairStatusEnum;
...
public class MesDvRepairServiceImpl implements MesDvRepairService {
    ...
    @Override
    public void confirmRepair(cn.cheers.x.mes.controller.admin.dv.repair.vo.MesDvRepairConfirmReqVO confirmReqVO) {
        // 1. 校验存在，且状态为维修中
