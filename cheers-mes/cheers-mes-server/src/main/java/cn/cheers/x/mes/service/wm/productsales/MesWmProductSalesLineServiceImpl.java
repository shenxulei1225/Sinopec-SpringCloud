...
import cn.cheers.x.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import cn.cheers.x.mes.enums.qc.MesQcCheckResultEnum;
...
import cn.cheers.x.mes.dal.dataobject.wm.salesnotice.MesWmSalesNoticeLineDO;
import cn.cheers.x.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public cn.cheers.x.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return cn.cheers.x.framework.common.pojo.PageResult.empty();
            }
