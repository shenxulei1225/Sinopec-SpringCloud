package cn.cheers.x.mes.controller.admin.dv.repair;
...
import cn.cheers.x.mes.controller.admin.dv.repair.vo.MesDvRepairPageReqVO;
import cn.cheers.x.mes.controller.admin.dv.repair.vo.MesDvRepairRespVO;
import cn.cheers.x.mes.controller.admin.dv.repair.vo.MesDvRepairSaveReqVO;
import cn.cheers.x.mes.dal.dataobject.dv.machinery.MesDvMachineryDO;
import cn.cheers.x.mes.dal.dataobject.dv.repair.MesDvRepairDO;
...
public class MesDvRepairController {
    ...
    @PreAuthorize("@ss.hasPermission('mes:dv-repair:update')")
    public CommonResult<Boolean> confirmRepair(@Valid @RequestBody cn.cheers.x.mes.controller.admin.dv.repair.vo.MesDvRepairConfirmReqVO confirmReqVO) {
