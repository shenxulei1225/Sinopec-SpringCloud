package cn.cheers.x.inspection.inspection_content.dal.dataobject.object;
...
public class InspectionObjectSourceDO extends BaseDO {
     ...
     * 适配器实现类。
     *
     * <p>实现 {@link cn.cheers.x.inspection.inspection_content.service.source.ObjectSourceAdapter}</p>
     * <p>用于查询该来源的具体对象列表。</p>
     */
