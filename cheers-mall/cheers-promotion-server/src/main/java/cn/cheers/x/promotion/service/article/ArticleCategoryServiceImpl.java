...
import cn.cheers.x.promotion.controller.admin.article.vo.category.ArticleCategoryCreateReqVO;
import cn.cheers.x.promotion.controller.admin.article.vo.category.ArticleCategoryPageReqVO;
import cn.cheers.x.promotion.controller.admin.article.vo.category.ArticleCategoryUpdateReqVO;
import cn.cheers.x.promotion.convert.article.ArticleCategoryConvert;
import cn.cheers.x.promotion.dal.dataobject.article.ArticleCategoryDO;
import cn.cheers.x.promotion.dal.mysql.article.ArticleCategoryMapper;
...
import static cn.cheers.x.promotion.enums.ErrorCodeConstants.ARTICLE_CATEGORY_DELETE_FAIL_HAVE_ARTICLES;
