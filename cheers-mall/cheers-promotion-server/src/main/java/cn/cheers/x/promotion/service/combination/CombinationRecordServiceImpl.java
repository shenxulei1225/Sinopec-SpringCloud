package cn.cheers.x.promotion.service.combination;
...
import cn.cheers.x.promotion.api.combination.dto.CombinationValidateJoinRespDTO;
import cn.cheers.x.promotion.controller.admin.combination.vo.recrod.CombinationRecordReqPageVO;
import cn.cheers.x.promotion.controller.app.combination.vo.record.AppCombinationRecordPageReqVO;
import cn.cheers.x.promotion.convert.combination.CombinationActivityConvert;
...
import cn.cheers.x.promotion.dal.mysql.combination.CombinationRecordMapper;
...
import cn.cheers.x.trade.enums.order.TradeOrderCancelTypeEnum;
...
import static cn.cheers.x.framework.common.util.date.LocalDateTimeUtils.afterNow;
import static cn.cheers.x.framework.common.util.date.LocalDateTimeUtils.beforeNow;
import static cn.cheers.x.promotion.enums.ErrorCodeConstants.*;
import static cn.cheers.x.promotion.enums.MessageTemplateConstants.COMBINATION_SUCCESS;
