package cn.cheers.x.trade.service.brokerage;
...
import cn.cheers.x.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import cn.cheers.x.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import cn.cheers.x.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import cn.cheers.x.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import cn.cheers.x.trade.convert.brokerage.BrokerageRecordConvert;
import cn.cheers.x.trade.dal.dataobject.brokerage.BrokerageRecordDO;
import cn.cheers.x.trade.dal.dataobject.brokerage.BrokerageUserDO;
import cn.cheers.x.trade.dal.dataobject.config.TradeConfigDO;
import cn.cheers.x.trade.dal.mysql.brokerage.BrokerageRecordMapper;
import cn.cheers.x.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import cn.cheers.x.trade.enums.brokerage.BrokerageRecordStatusEnum;
import cn.cheers.x.trade.service.brokerage.bo.BrokerageAddReqBO;
import cn.cheers.x.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
import cn.cheers.x.trade.service.config.TradeConfigService;
...
import static cn.cheers.x.framework.common.util.collection.CollectionUtils.getMinValue;
import static cn.cheers.x.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static cn.cheers.x.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
