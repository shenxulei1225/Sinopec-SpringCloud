...
# scripts is under cheers-module-business-middle-platform/scripts → repo root is 3 levels up from scripts? 
# path: Sinopec-SpringCloud/cheers-module-business-middle-platform/scripts → ../../.. = Sinopec-SpringCloud
