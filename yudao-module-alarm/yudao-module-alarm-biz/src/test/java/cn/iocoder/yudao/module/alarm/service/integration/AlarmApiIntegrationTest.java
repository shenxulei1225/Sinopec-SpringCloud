...
public class AlarmApiIntegrationTest extends BaseDbUnitTest {
    ...
    void testGetLinkageExecutionsByAlarmId() {
        ...
        // 查询联动执行记录
        List<LinkageExecutionDO> result = linkageExecutionMapper.selectListByAlarmId(alarm.getId());
    ...
    void testGetManualInterventionExecutions() {
        ...
        // 查询需要人工介入的记录
        List<LinkageExecutionDO> result = linkageExecutionMapper.selectListNeedManualIntervention();
