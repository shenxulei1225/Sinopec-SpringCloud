...
import cn.iocoder.yudao.module.alarm.service.linkage.executor.*;
...
public class AlarmLinkageIntegrationTest extends BaseDbUnitTest {
    ...
    void testTestLinkageRule_EmptyActions() {
        // 准备测试请求
        var reqVO = new cn.iocoder.yudao.module.alarm.controller.admin.vo.linkage.LinkageRuleTestReqVO();
        reqVO.setActions("[]");
