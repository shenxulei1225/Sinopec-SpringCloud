...
@Schema(description = "管理后台 - 应急指令模板更新 Request VO")
@Data
public class EmergencyCommandTemplateUpdateReqVO {

    @Schema(description = "模板编号。注意：如果ID是很大的整数（超过2^53），前端应传递字符串类型以避免JavaScript精度丢失", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
