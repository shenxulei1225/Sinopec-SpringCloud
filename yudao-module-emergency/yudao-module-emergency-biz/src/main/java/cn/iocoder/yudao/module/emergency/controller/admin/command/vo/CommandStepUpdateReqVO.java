...
/**
 * 管理后台 - 指令步骤更新 Request VO
 */
@Schema(description = "管理后台 - 指令步骤更新 Request VO")
@Data
public class CommandStepUpdateReqVO {

    @Schema(description = "步骤编号。注意：如果ID是很大的整数（超过2^53），前端应传递字符串类型以避免JavaScript精度丢失", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
