...
# scripts is under cheers-business-middle-platform/scripts → repo root is 3 levels up from scripts? 
# path: Sinopec-SpringCloud/cheers-business-middle-platform/scripts → ../../.. = Sinopec-SpringCloud
