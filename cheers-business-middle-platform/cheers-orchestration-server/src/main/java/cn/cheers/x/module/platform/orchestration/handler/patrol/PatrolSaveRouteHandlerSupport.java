...
/**
 * 从排程上下文解析 PatrolSaveRouteReqDTO。
 */
final class PatrolSaveRouteHandlerSupport {

    static final String FACILITY_ID = "facilityId";
    static final String TASK_ID = "taskId";

    private PatrolSaveRouteHandlerSupport() {
    }

    static PatrolSaveRouteReqDTO toReq(PhaseContext context) {
