...
import cn.cheers.x.bpm.controller.admin.task.vo.task.*;
import cn.cheers.x.bpm.convert.task.BpmTaskConvert;
import cn.cheers.x.bpm.dal.dataobject.definition.BpmFormDO;
import cn.cheers.x.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.cheers.x.bpm.enums.definition.*;
import cn.cheers.x.bpm.enums.task.BpmCommentTypeEnum;
import cn.cheers.x.bpm.enums.task.BpmReasonEnum;
import cn.cheers.x.bpm.enums.task.BpmTaskSignTypeEnum;
...
import cn.cheers.x.bpm.service.definition.BpmFormService;
import cn.cheers.x.bpm.service.definition.BpmModelService;
...
import cn.cheers.x.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static cn.cheers.x.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
//        }
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 cheers-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
