package cn.cheers.x.bpm.service.task;
...
import cn.cheers.x.framework.common.util.date.DateUtils;
import cn.cheers.x.framework.common.util.json.JsonUtils;
import cn.cheers.x.framework.common.util.object.ObjectUtils;
import cn.cheers.x.framework.common.util.object.PageUtils;
import cn.cheers.x.framework.datapermission.core.annotation.DataPermission;
import cn.cheers.x.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.cheers.x.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.cheers.x.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.cheers.x.bpm.controller.admin.task.vo.instance.*;
import cn.cheers.x.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.cheers.x.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.cheers.x.bpm.convert.task.BpmProcessInstanceConvert;
import cn.cheers.x.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.cheers.x.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.cheers.x.bpm.enums.ErrorCodeConstants;
import cn.cheers.x.bpm.enums.definition.BpmModelTypeEnum;
import cn.cheers.x.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.cheers.x.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.cheers.x.bpm.enums.task.BpmReasonEnum;
import cn.cheers.x.bpm.enums.task.BpmTaskStatusEnum;
import cn.cheers.x.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.cheers.x.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.cheers.x.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.cheers.x.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.cheers.x.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.cheers.x.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.cheers.x.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.cheers.x.bpm.framework.flowable.core.util.FlowableUtils;
import cn.cheers.x.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.cheers.x.bpm.service.definition.BpmProcessDefinitionService;
import cn.cheers.x.bpm.service.message.BpmMessageService;
...
import static cn.cheers.x.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.cheers.x.bpm.enums.ErrorCodeConstants.*;
import static cn.cheers.x.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.cheers.x.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
