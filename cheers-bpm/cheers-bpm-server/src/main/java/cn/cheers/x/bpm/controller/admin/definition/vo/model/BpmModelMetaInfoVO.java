package cn.cheers.x.bpm.controller.admin.definition.vo.model;
...
import cn.cheers.x.bpm.enums.definition.BpmAutoApproveTypeEnum;
 ...
 *
 * 最终，它的字段和
 * {@link cn.cheers.x.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO}
 * 是一致的
 *
 * 
 */
...
public class BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程图标", example = "https://example.com/demo.jpg")
