package cn.cheers.x.bpm.framework.rpc.config;

import cn.cheers.x.bpm.api.event.CrmContractStatusListener;
import cn.cheers.x.bpm.api.event.CrmReceivableStatusListener;
