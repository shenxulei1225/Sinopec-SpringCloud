package cn.cheers.x.erp.dal.dataobject.purchase;
...
public class ErpPurchaseInDO extends BaseDO {
     ...
     * 入库状态
     *
     * 枚举 {@link cn.cheers.x.erp.enums.ErpAuditStatus}
     */
     ...
     * 已支付金额，单位：元
     *
     * 目的：和 {@link cn.cheers.x.erp.dal.dataobject.finance.ErpFinancePaymentDO} 结合，记录已支付金额
     */
