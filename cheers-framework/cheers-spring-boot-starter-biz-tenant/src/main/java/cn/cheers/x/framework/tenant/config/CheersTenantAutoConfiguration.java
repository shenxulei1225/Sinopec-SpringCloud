...
import cn.cheers.x.framework.redis.config.CheersCacheProperties;
import cn.cheers.x.framework.security.core.service.SecurityFrameworkService;
import cn.cheers.x.framework.tenant.core.aop.TenantIgnore;
import cn.cheers.x.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.cheers.x.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.cheers.x.framework.tenant.core.job.TenantJobAspect;
import cn.cheers.x.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.cheers.x.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.cheers.x.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.cheers.x.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.cheers.x.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.cheers.x.framework.tenant.core.service.TenantFrameworkService;
import cn.cheers.x.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.cheers.x.framework.tenant.core.web.TenantContextWebFilter;
import cn.cheers.x.framework.tenant.core.web.TenantVisitContextInterceptor;
import cn.cheers.x.framework.web.config.WebProperties;
import cn.cheers.x.framework.web.core.handler.GlobalExceptionHandler;
...
public class CheersTenantAutoConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "cn.cheers.x.framework.mq.redis.core.RedisMQTemplate")
