package cn.cheers.x.framework.desensitize.core;

import cn.cheers.x.framework.common.util.json.JsonUtils;
import cn.cheers.x.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.cheers.x.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.cheers.x.framework.desensitize.core.annotation.Address;
import cn.cheers.x.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import cn.cheers.x.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import cn.cheers.x.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import cn.cheers.x.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import cn.cheers.x.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import cn.cheers.x.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import cn.cheers.x.framework.desensitize.core.slider.annotation.MobileDesensitize;
import cn.cheers.x.framework.desensitize.core.slider.annotation.SliderDesensitize;
import lombok.Data;
