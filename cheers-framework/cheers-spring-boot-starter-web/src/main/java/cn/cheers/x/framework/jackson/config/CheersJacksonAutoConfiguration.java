package cn.cheers.x.framework.jackson.config;

import cn.cheers.x.framework.common.util.json.JsonUtils;
import cn.cheers.x.framework.common.util.json.databind.NumberSerializer;
import cn.cheers.x.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.cheers.x.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class CheersJacksonAutoConfiguration {
