...
import cn.cheers.x.framework.web.config.CheersWebAutoConfiguration;
...
@AutoConfiguration(after = CheersWebAutoConfiguration.class)
public class CheersApiLogAutoConfiguration implements WebMvcConfigurer {
