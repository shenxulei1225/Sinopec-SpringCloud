package cn.cheers.x.ai.framework.ai.core.model;
...
import cn.cheers.x.ai.enums.model.AiPlatformEnum;
import cn.cheers.x.ai.framework.ai.config.AiAutoConfiguration;
import cn.cheers.x.ai.framework.ai.config.CheersAiProperties;
...
import cn.cheers.x.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.cheers.x.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            CheersAiProperties.Midjourney properties = SpringUtil.getBean(CheersAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(CheersAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        CheersAiProperties.DouBao properties = new CheersAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(CheersAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        CheersAiProperties.HunYuan properties = new CheersAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(CheersAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        CheersAiProperties.SiliconFlow properties = new CheersAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(CheersAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        CheersAiProperties.XingHuo properties = new CheersAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(CheersAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        CheersAiProperties.BaiChuan properties = new CheersAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(CheersAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        CheersAiProperties.Gemini properties = SpringUtil.getBean(CheersAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        CheersAiProperties.Grok properties = new CheersAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
