...
import cn.cheers.x.alarm.convert.AlarmRuleConvert;
import cn.cheers.x.alarm.dal.dataobject.AlarmRuleDO;
import cn.cheers.x.alarm.dal.mysql.AlarmRuleMapper;
import cn.cheers.x.alarm.enums.AlarmRuleTypeEnum;
import cn.cheers.x.alarm.framework.cache.AlarmQueryCacheService;
import cn.cheers.x.alarm.framework.cache.DeviceDataCacheService;
import cn.cheers.x.alarm.service.rule.pattern.DataPoint;
import cn.cheers.x.alarm.service.rule.pattern.PatternDetectionResult;
import cn.cheers.x.alarm.service.rule.pattern.PatternDetectorManager;
