package cn.cheers.x.system.service.tenant;
...
import cn.cheers.x.framework.tenant.config.TenantProperties;
...
import cn.cheers.x.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import cn.cheers.x.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.cheers.x.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.cheers.x.system.convert.tenant.TenantConvert;
import cn.cheers.x.system.dal.dataobject.permission.MenuDO;
import cn.cheers.x.system.dal.dataobject.permission.RoleDO;
import cn.cheers.x.system.dal.dataobject.tenant.TenantDO;
import cn.cheers.x.system.dal.dataobject.tenant.TenantPackageDO;
import cn.cheers.x.system.dal.mysql.tenant.TenantMapper;
import cn.cheers.x.system.enums.permission.RoleCodeEnum;
import cn.cheers.x.system.enums.permission.RoleTypeEnum;
...
import cn.cheers.x.system.service.tenant.handler.TenantInfoHandler;
import cn.cheers.x.system.service.tenant.handler.TenantMenuHandler;
import cn.cheers.x.system.service.user.AdminUserService;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 cheers.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
