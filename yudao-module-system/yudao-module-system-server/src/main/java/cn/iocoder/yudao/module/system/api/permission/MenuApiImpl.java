...
public class MenuApiImpl implements MenuApi {
    ...
    public CommonResult<Long> createMenu(MenuSaveReqDTO createReqDTO) {
        return success(menuService.createMenu(BeanUtils.toBean(createReqDTO, cn.iocoder.yudao.module.system.controller.admin.permission.vo.menu.MenuSaveVO.class)));
    }

    @Override
    public CommonResult<Boolean> updateMenu(MenuSaveReqDTO updateReqDTO) {
        menuService.updateMenu(BeanUtils.toBean(updateReqDTO, cn.iocoder.yudao.module.system.controller.admin.permission.vo.menu.MenuSaveVO.class));
        return success(true);
    }
