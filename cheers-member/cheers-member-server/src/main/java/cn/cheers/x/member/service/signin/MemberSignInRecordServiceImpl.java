package cn.cheers.x.member.service.signin;
...
import cn.cheers.x.member.controller.admin.signin.vo.record.MemberSignInRecordPageReqVO;
import cn.cheers.x.member.controller.app.signin.vo.record.AppMemberSignInRecordSummaryRespVO;
import cn.cheers.x.member.convert.signin.MemberSignInRecordConvert;
import cn.cheers.x.member.dal.dataobject.signin.MemberSignInConfigDO;
import cn.cheers.x.member.dal.dataobject.signin.MemberSignInRecordDO;
import cn.cheers.x.member.dal.dataobject.user.MemberUserDO;
import cn.cheers.x.member.dal.mysql.signin.MemberSignInRecordMapper;
import cn.cheers.x.member.enums.MemberExperienceBizTypeEnum;
import cn.cheers.x.member.enums.point.MemberPointBizTypeEnum;
import cn.cheers.x.member.service.level.MemberLevelService;
import cn.cheers.x.member.service.point.MemberPointRecordService;
...
import static cn.cheers.x.member.enums.ErrorCodeConstants.SIGN_IN_RECORD_TODAY_EXISTS;
