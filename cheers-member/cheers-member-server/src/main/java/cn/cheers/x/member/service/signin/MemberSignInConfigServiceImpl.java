...
import cn.cheers.x.member.controller.admin.signin.vo.config.MemberSignInConfigCreateReqVO;
import cn.cheers.x.member.controller.admin.signin.vo.config.MemberSignInConfigUpdateReqVO;
import cn.cheers.x.member.convert.signin.MemberSignInConfigConvert;
import cn.cheers.x.member.dal.dataobject.signin.MemberSignInConfigDO;
import cn.cheers.x.member.dal.mysql.signin.MemberSignInConfigMapper;
...
import static cn.cheers.x.member.enums.ErrorCodeConstants.SIGN_IN_CONFIG_EXISTS;
import static cn.cheers.x.member.enums.ErrorCodeConstants.SIGN_IN_CONFIG_NOT_EXISTS;
