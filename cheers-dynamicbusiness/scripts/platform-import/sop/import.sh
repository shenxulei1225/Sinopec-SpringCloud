...
echo "== sop: catalog-orchestration helpers =="
run "${SCRIPT_DIR}/../catalog-orchestration/00_helpers.sql"
echo "== sop: catalog orchestration =="
run "${SCRIPT_DIR}/08_catalog_orchestration.sql"
