-- ============================================================================
-- catalog-orchestration · 06 标准检查库实体列对齐
-- 原则：编排头在 dm_catalog_orchestration；开哪些栏认 dm_data_tab_layout。
-- 本页目标=检查项 → layout 须有开启的 ENTITY 行；不得用 MODEL 行冒充检查项。
-- 前置：01_p0 已为 inspection_item 写编排头（点列表这一行）。
-- ============================================================================
