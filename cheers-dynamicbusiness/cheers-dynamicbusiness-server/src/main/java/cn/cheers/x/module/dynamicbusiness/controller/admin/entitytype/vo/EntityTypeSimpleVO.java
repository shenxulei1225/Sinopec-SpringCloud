 ...
 * <h3>应用场景</h3>
 * <ul>
 *   <li><b>接口</b>：GET /system/entity-type/simple-list</li>
 ...
 * 
 * <h3>设计说明</h3>
 * <p>相比 {@link EntityTypeRespVO}，本 VO 只包含 code、name、description 三个字段，
 * 减少数据传输量，提升下拉框加载性能。</p>
 * 
 * <h3>与其他 VO 的关系</h3>
 * <ul>
 *   <li>完整版本 → {@link EntityTypeRespVO}</li>
 * </ul>
 * 
 * @author yudao
 */
@Schema(description = "管理后台 - EntityType 简单 VO")
@Data
public class EntityTypeSimpleVO {
