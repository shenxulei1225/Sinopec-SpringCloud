 ...
 * @since 2022-03-21
 */
@TableName(value = "dynamic_mail_account", autoResultMap = true)
@KeySequence("dynamic_mail_account_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
