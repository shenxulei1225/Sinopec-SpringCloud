 ...
 *   <li>按 (entityTypeCode, modelId) 读取模型级表单定义；</li>
...
public interface ModelCrudFormDefinitionMapper extends BaseMapperX<ModelCrudFormDefinitionDO> {
     ...
     */
    default ModelCrudFormDefinitionDO selectByEntityTypeAndModel(String entityTypeCode, Long modelId) {
        return selectOne(new LambdaQueryWrapperX<ModelCrudFormDefinitionDO>()
                .eq(ModelCrudFormDefinitionDO::getEntityTypeCode, entityTypeCode)
