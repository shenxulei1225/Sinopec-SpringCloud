...
-- 根因：target_entity_type 为空 + crud-form refTarget 指向 equipment，picker 选中了同表设备 id（如 64/65）
SET search_path TO dynamicbusiness;

UPDATE ent_equipment e
