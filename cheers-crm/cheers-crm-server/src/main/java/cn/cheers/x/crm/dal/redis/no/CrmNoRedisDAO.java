package cn.cheers.x.crm.dal.redis.no;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import cn.cheers.x.crm.dal.redis.RedisKeyConstants;
...
public class CrmNoRedisDAO {
    ...
    /**
     * 合同 {@link cn.cheers.x.crm.dal.dataobject.contract.CrmContractDO}
     */
    public static final String CONTRACT_NO_PREFIX = "HT";

    /**
     * 回款 {@link cn.cheers.x.crm.dal.dataobject.receivable.CrmReceivablePlanDO}
     */
