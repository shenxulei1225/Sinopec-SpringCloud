...
('facility-category', 'facility', 'tree', '设施分类', 'folder', '{"url": "/system/category/tree", "method": "GET", "params": {"categoryTypeCode": "FACILITY"}}', '{"dataEndpoint": {"url": "/system/category/tree", "method": "GET"}, "createEndpoint": {"url": "/system/category/create", "method": "POST"}, "updateEndpoint": {"url": "/system/category/update", "method": "PUT"}, "deleteEndpoint": {"url": "/system/category/delete", "method": "DELETE"}, "dragEndpoint": {"url": "/system/category/drag", "method": "POST"}}', '[{"id": "default", "name": "默认布局", "isSystem": true, "schema": {"type": "tree"}}]', 1);
